...
img_path_list=glob.glob('./val2014/*')
...
for i in img_path_list:
  ...
  plt.imsave('./val2014_input/'+img_name,squre_img)
  ...
  plt.imsave('./val2014_template/'+img_name,simulated_drone_img[32:160,32:160,:])
  ...
  with open('./val2014_label/'+img_name[:(len(img_name)-4)]+'_label.txt', 'w') as outfile:
